  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="size-9 relative overflow-hidden bg-fuchsia-700 hover:bg-fuchsia-700/80 font-semibold text-xl shadow-lg">
          {workspaceLoading ? (
      ...
      <DropdownMenuContent side="bottom" align="start" className="w-64">
        ...
        {filteredWorkspaces?.map((workspace) => (
          ...
          >
            <div className="shrink-0 size-9 relative overflow-hidden bg-fuchsia-800/90 text-white font-semibold text-lg rounded-md flex items-center justify-center mr-2">
              {workspace.name.charAt(0).toUpperCase()}
            </div>
