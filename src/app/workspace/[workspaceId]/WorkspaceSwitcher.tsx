  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="size-10 relative overflow-hidden bg-fuchsia-700 hover:bg-fuchsia-700/80 dark:bg-slate-100 dark:hover:bg-slate-200 font-semibold text-xl shadow-lg">
          {workspaceLoading ? (
      ...
      <DropdownMenuContent side="bottom" align="start" className="w-64">
        ...
        <div className="overflow-auto messages-scrollbar max-h-40">
